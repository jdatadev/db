...
abstract class BaseLargeNodeListTest<T extends BaseLargeNodeList<?, ?, ?> & ISingleHeadNodeListGetters & IOnlyElementsView> extends BaseLongNodeListTest {
    ...
    abstract boolean containsOnly(T list, long value, ILongContainsOnlyPredicate predicate);

    abstract long[] toArray(T list);

    abstract long addHeadReturnNode(T list, long value);
    abstract long addTailAndReturnNode(T list, long value);
    ...
    public final void testAddHead() {
        ...
        addHeadReturnNode(list, 234L);
        checkElements(list, 234L, 123L);

        addHeadReturnNode(list, 345L);
    ...
    public final void testAddTail() {
        ...
        addTailAndReturnNode(list, 123L);
        checkElements(list, 123L);

        addTailAndReturnNode(list, 234L);
    ...
    public final void testRemoveHead() {
        ...
        assertThat(removeHeadAndReturnValue(list)).isEqualTo(345L);
        checkElements(list, 234L, 123L);

        assertThat(removeHeadAndReturnValue(list)).isEqualTo(234L);
        checkElements(list, 123L);

        assertThat(removeHeadAndReturnValue(list)).isEqualTo(123L);
    ...
    public final void testRemoveNode() {
        ...
        final long node1 = addHeadReturnNode(list, 123L);
        final long node2 = addHeadReturnNode(list, 234L);
        final long node3 = addHeadReturnNode(list, 345L);
    ...
    public final void testFreeListRemoveHead() {
        ...
        final long node3 = addHeadReturnNode(list, 345L);
        final long node4 = addHeadReturnNode(list, 456L);
    ...
    public final void testFreeListRemove() {
        ...
        final long node3 = addHeadReturnNode(list, 345L);
        final long node4 = addHeadReturnNode(list, 456L);
        final long node5 = addHeadReturnNode(list, 567L);
    ...
    final void checkAddTailLongDoublyLinkedList() {
        ...
        addTailAndReturnNode(list, 123L);
        addTailAndReturnNode(list, 234L);
        addTailAndReturnNode(list, 345L);
    ...
    static <T extends BaseLargeNodeList<?, ?, ?>> void checkFreeListIsEmpty(T list) {

        assertThat(list.freeListToArray()).isEmpty();
    }

    static <T extends BaseLargeNodeList<?, ?, ?>> void checkFreeListElements(T list, long ... elements) {
