...
public final class MutableLongLargeSinglyLinkedMultiHeadNodeListTest extends BaseLargeMultiHeadNodeListTest {

    @Test
    @Category(UnitTest.class)
    public void testRemoveNodeByValue() {

        final MutableLongLargeSinglyLinkedMultiHeadNodeList<TestList> list = HeapMutableLongLargeSinglyLinkedMultiHeadNodeList.create(AllocationType.HEAP, 1, 1);
