...
public final class CollTest extends BaseTest {
    ...
    public void testMax() {
        ...
        assertThatThrownBy(() -> Coll.max(Arrays.asList(1, 2, 3), 0, null)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> Coll.max(Arrays.asList(1, 2, 3), 0, null)).isInstanceOf(NullPointerException.class);

        assertThat(Coll.max(Collections.emptyList(), 0,     Integer::intValue)).isEqualTo(0);
        assertThat(Coll.max(Collections.emptyList(), 123,   Integer::intValue)).isEqualTo(123);

        assertThat(Coll.max(Arrays.asList(0),               123, Integer::intValue)).isEqualTo(0);
        assertThat(Coll.max(Arrays.asList(0, 1),            123, Integer::intValue)).isEqualTo(1);
        assertThat(Coll.max(Arrays.asList(1, 2 ,0),         123, Integer::intValue)).isEqualTo(2);
        assertThat(Coll.max(Arrays.asList(1, 0, -2),        123, Integer::intValue)).isEqualTo(1);
        assertThat(Coll.max(Arrays.asList(1, 0, 1, -2),     123, Integer::intValue)).isEqualTo(1);
        assertThat(Coll.max(Arrays.asList(-1, 0, -1, -2),   123, Integer::intValue)).isEqualTo(0);
        assertThat(Coll.max(Arrays.asList(-1, -3, -1, -2),  123, Integer::intValue)).isEqualTo(-1);
    }
    ...
    private void checkSorted(BiFunction<Collection<Integer>, Comparator<Integer>, List<Integer>> sorter, Consumer<List<Integer>> resultConsumer) {
        ...
        assertThatThrownBy(() -> sorter.apply(Collections.emptyList(), null)).isInstanceOf(NullPointerException.class);
    ...
    public void testToArray() {
        ...
        assertThatThrownBy(() -> Coll.toArray(Arrays.asList(1), null)).isInstanceOf(NullPointerException.class);

        assertThat(Coll.toArray(Collections.emptyList(), Integer[]::new)).isEmpty();
        assertThat(Coll.toArray(Arrays.asList(1), Integer[]::new)).containsExactly(1);
        assertThat(Coll.toArray(Arrays.asList(1, 2, 3), Integer[]::new)).containsExactly(1, 2, 3);
    }
    ...
    public void testToArrayByIndex() {
        ...
        assertThatThrownBy(() -> Coll.toArray(Arrays.asList(1), 1, null, List::get)).isInstanceOf(NullPointerException.class);
        assertThatThrownBy(() -> Coll.toArray(Arrays.asList(1), 1, Integer[]::new, null)).isInstanceOf(NullPointerException.class);

        assertThatThrownBy(() -> Coll.toArray(Arrays.asList(1), -1, Integer[]::new, List::get)).isInstanceOf(IllegalArgumentException.class);

        assertThat(Coll.toArray(Collections.emptyList(), 0, Integer[]::new, List::get)).isEmpty();
        assertThat(Coll.toArray(Arrays.asList(1), 1, Integer[]::new, List::get)).containsExactly(1);
        assertThat(Coll.toArray(Arrays.asList(1, 2, 3), 1, Integer[]::new, List::get)).containsExactly(1);
        assertThat(Coll.toArray(Arrays.asList(1, 2, 3), 2, Integer[]::new, List::get)).containsExactly(1, 2);
        assertThat(Coll.toArray(Arrays.asList(1, 2, 3), 3, Integer[]::new, List::get)).containsExactly(1, 2, 3);
    }
}
