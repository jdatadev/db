...
public final class MutableLongLargeSinglyLinkedListTest extends BaseLongLargeNodeListTest<MutableLongLargeSinglyLinkedNodeList> {

    @Override
    MutableLongLargeSinglyLinkedNodeList createLargeList(int initialOuterCapacity, int innerCapacity) {

        return new MutableLongLargeSinglyLinkedNodeList(initialOuterCapacity, innerCapacity);
    }

    @Override
    long removeTailNode(MutableLongLargeSinglyLinkedNodeList list, long newTailNode) {

        return list.removeTailNodeAndReturnNode(newTailNode);
    }

    @Override
    void removeNode(MutableLongLargeSinglyLinkedNodeList list, long node, long previousNode) {

        list.removeNode(node, previousNode);
    }

    @Override
    void clear(MutableLongLargeSinglyLinkedNodeList list) {
    ...
    public void testRemoveHeadNode() {
        ...
        final MutableLongLargeSinglyLinkedNodeList list = new MutableLongLargeSinglyLinkedNodeList(10, 100);
