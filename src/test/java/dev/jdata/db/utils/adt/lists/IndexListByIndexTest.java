...
public final class IndexListByIndexTest extends BaseByIndexTest {
    ...
    protected <T, R> R[] map(T[] array, IntFunction<R[]> createMappedArray, Function<T, R> mapper) {
        ...
        final LongFunction<IIndexListBuilder<R, IHeapIndexList<R>, ?>> createIndexListAddable = l -> HeapObjectIndexListBuilder.create(AllocationType.HEAP, createMappedArray);
