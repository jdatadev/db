...
public final class MutableObjectLargeArrayTest extends BaseLargeArrayTest<Integer[][], Integer[], MutableObjectLargeArray<Integer>> {

    @Override
    MutableObjectLargeArray<Integer> createArray(int initialOuterCapacity, int innerCapacityExponent) {

        return HeapMutableObjectLargeArray.create(AllocationType.HEAP, initialOuterCapacity, innerCapacityExponent, Integer[][]::new, Integer[]::new);
    }

    @Override
    MutableObjectLargeArray<Integer> createArray(int initialOuterCapacity, int innerCapacityExponent, int clearValue) {

        return HeapMutableObjectLargeArray.create(AllocationType.HEAP, initialOuterCapacity, innerCapacityExponent, Integer[][]::new, Integer[]::new, clearValue);
    }
