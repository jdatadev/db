...
public final class DDLTransactionTest extends BaseDBTest {
    ...
    public void testCreateTable() throws ParserException, SQLValidationException, IOException {
        ...
        final EffectiveDatabaseSchema newEffectiveDatabaseSchema = checkDDLOperation(createTableSQL, SQLCreateTableStatement.class, stringStorer, EffectiveDatabaseSchema::empty,
                createTableSQL);
    ...
    public void testDropTable() throws ParserException, SQLValidationException, IOException {
        ...
        final EffectiveDatabaseSchema newEffectiveDatabaseSchema = checkDDLOperation(dropTableSQL, SQLDropTableStatement.class, stringStorer,
    ...
    private static <T extends BaseSQLDDLOperationStatement> EffectiveDatabaseSchema checkDDLOperation(String sql, Class<T> sqlStatementClass, StringStorer stringStorer,
    ...
    private static void checkDBNamedObject(DBNamedObject dbNamedObject, StringStorer stringStorer, String expectedName) {

        checkDBNamedObject(dbNamedObject, stringStorer, expectedName, expectedName);
    }

    private static void checkDBNamedObject(DBNamedObject dbNamedObject, StringStorer stringStorer, String expectedParsedName, String expectedStoredName) {
