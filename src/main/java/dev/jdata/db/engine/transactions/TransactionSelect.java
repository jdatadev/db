...
public final class TransactionSelect extends ObjectCacheNode implements IClearable {
    ...
    private IArray<SelectColumn> selectColumns;
    ...
    public void initialize(int tableId, ConditionOperator conditionOperator, IArray<SelectColumn> selectColumns, IBaseMutableLongSet rowIdsToFilter,
