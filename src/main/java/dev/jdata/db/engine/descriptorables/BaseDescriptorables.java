...
public abstract class BaseDescriptorables<T extends Enum<T> & State, U extends BaseDescriptorable<T>, V extends IFreeing<U> & IContainsView> extends BaseNumElements<Void, Void, Void> {
    ...
    protected final U getDescriptorable(int descriptor) {
        ...
        Checks.checkIntIndex(descriptor, numArrayElements);
