...
public final class ExecutePreparedStatementBatchMessage extends BatchParameterPreparedStatementMessage {

    ExecutePreparedStatementBatchMessage(AllocationType allocationType) {
    ...
    public ProtocolMessageType getMessageType() {
        ...
        return ProtocolMessageType.EXECUTE_PREPARED_STATEMENT_BATCH;
    }
