...
public abstract class BuilderTrackingAllocator<T extends IBuilder> extends TrackingInstanceAllocator implements IBuilderAllocator<T> {
    ...
    protected BuilderTrackingAllocator() {
