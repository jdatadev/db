...
abstract class BaseIntToLongNonBucketMap<M extends IBaseIntToLongMapCommon<M>> extends BaseIntArrayKeysNonBucketMap<long[]> implements IBaseIntToLongMapCommon<M> {
    ...
    BaseIntToLongNonBucketMap(BaseIntToLongNonBucketMap<M> toCopy) {
