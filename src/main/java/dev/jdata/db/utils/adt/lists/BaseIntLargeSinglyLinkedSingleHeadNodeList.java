...
abstract class BaseIntLargeSinglyLinkedSingleHeadNodeList<VALUES extends BaseIntInnerOuterNodeListValues>

        extends BaseIntLargeSinglyLinkedNodeList<BaseIntLargeSinglyLinkedSingleHeadNodeList<VALUES>, VALUES>
        implements IIntSinglyLinkedSingleHeadNodeListCommon {
    ...
    BaseIntLargeSinglyLinkedSingleHeadNodeList(AllocationType allocationType, int initialOuterCapacity, int innerCapacity,
