...
final class MutableIntLargeArray extends LimitLargeArray<int[][], int[]> implements IMutableIntLargeArray {

    private static final boolean DEBUG = DebugConstants.DEBUG_MUTABlE_INT_LARGE_ARRAY;

    private static final Class<?> debugClass = MutableIntLargeArray.class;

    static MutableIntLargeArray copyOf(MutableIntLargeArray toCopy) {
        ...
        final MutableIntLargeArray result = new MutableIntLargeArray(toCopy);
    ...
    MutableIntLargeArray(int initialOuterCapacity, int innerCapacityExponent) {
    ...
    MutableIntLargeArray(int initialOuterCapacity, int innerCapacityExponent, int clearValue) {
    ...
    MutableIntLargeArray(int initialOuterCapacity, int innerCapacityExponent, int clearValue, boolean hasClearValue) {
    ...
    private MutableIntLargeArray(MutableIntLargeArray toCopy) {
        super(toCopy, (s, d, n) -> {
