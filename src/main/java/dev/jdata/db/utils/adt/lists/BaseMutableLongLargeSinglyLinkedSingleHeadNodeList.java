...
abstract class BaseMutableLongLargeSinglyLinkedSingleHeadNodeList<VALUES extends BaseLongInnerOuterNodeListValues>
        ...
        implements IMutableLongLargeSinglyLinkedSingleHeadNodeList {
    ...
    @Override
    public final long removeNodeByFindingPrevious(long toRemove) {

        checkSingleHeadRemoveNodeByFindingPreviousParameters(toRemove);

        final long result = removeNodeByFindingPreviousNode(this, toRemove, getHeadNode(), getTailNode(), BaseLongLargeSinglyLinkedSingleHeadNodeList::setHeadNode,
                BaseLongLargeSinglyLinkedSingleHeadNodeList::setTailNode);
