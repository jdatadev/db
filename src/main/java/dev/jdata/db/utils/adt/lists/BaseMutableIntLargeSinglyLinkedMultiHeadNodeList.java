...
abstract class BaseMutableIntLargeSinglyLinkedMultiHeadNodeList<INSTANCE, VALUES extends BaseIntInnerOuterNodeListValues>

        extends BaseIntLargeSinglyLinkedMultiHeadNodeList<INSTANCE, VALUES>
        implements IMutableIntLargeSinglyLinkedMultiHeadNodeList<INSTANCE> {

    BaseMutableIntLargeSinglyLinkedMultiHeadNodeList(AllocationType allocationType, int initialOuterCapacity, int innerCapacity,
