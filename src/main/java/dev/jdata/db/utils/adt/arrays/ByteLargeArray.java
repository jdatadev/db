...
public final class ByteLargeArray extends BaseLargeByteArray {

    public ByteLargeArray(int innerCapacityExponent) {
        super(innerCapacityExponent);
    }

    public ByteLargeArray(int initialOuterCapacity, int innerCapacityExponent) {
