...
abstract class BaseLongLargeMaxDistanceNonBucketSet extends BaseLongLargeNonBucketSet implements ILongSetCommon {
    ...
    BaseLongLargeMaxDistanceNonBucketSet(int initialCapacityExponent, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor) {
    ...
    protected final IMutableLongLargeArray rehash(IMutableLongLargeArray hashArray, long newCapacity, int newCapacityExponent, long newKeyMask) {
        ...
        this.maxDistances = IMutableByteLargeArray.create(newCapacity);
