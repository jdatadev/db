...
abstract class BaseLongLargeDoublyLinkedNodeList<INSTANCE, VALUES extends BaseLongInnerOuterNodeListValues>
    ...
    BaseLongLargeDoublyLinkedNodeList(int initialOuterCapacity, int innerCapacity, ILargeNodeListValuesFactory<long[], ILongInnerOuterNodeListInternal, VALUES> valuesFactory) {
