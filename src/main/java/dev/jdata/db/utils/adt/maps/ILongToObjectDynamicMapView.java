...
public interface ILongToObjectDynamicMapView<V>

        extends ILongToObjectMapView<V>, IDynamicMapView, ILongContainsKeyMapView, ILongToObjectDynamicMapGetters<V>, IToObjectEqualsGetters<V, ILongToObjectDynamicMapView<V>> {

    @Override
    default <P1, P2, E extends Exception> boolean equalsParameters(ObjectValueMapScratchEqualsParameter<V, ILongToObjectDynamicMapView<V>, P1, P2, E> scratchEqualsParameter)
            throws E {
