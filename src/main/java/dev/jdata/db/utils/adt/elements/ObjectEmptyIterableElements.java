...
abstract class ObjectEmptyIterableElements<T> extends ObjectEmptyElements<T> implements IObjectIterableElementsView<T> {
    ...
    @Override
    public <P1, P2, E extends Exception> void forEach(P1 parameter1, P2 parameter2, IObjectForEach2<T, P1, P2, E> forEach) throws E {
    ...
    @Override
    public final <P> boolean contains(P parameter, BiPredicate<T, P> predicate) {
