...
abstract class LimitLargeArray<O, I> extends LargeArray<O, I> implements IOneDimensionalArrayCommon {
    ...
    LimitLargeArray(int initialOuterCapacity, int innerCapacityExponent, boolean hasClearValue, IntFunction<O> createOuterArray) {
    ...
    LimitLargeArray(LimitLargeArray<O, I> toCopy, IOuterAndInnerArraysCopier<O> copyOuterAndInnerArrays) {
