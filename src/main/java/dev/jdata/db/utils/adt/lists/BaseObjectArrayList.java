...
public abstract class BaseObjectArrayList<T> extends BaseArrayList<T[]> implements IObjectIndexListCommon<T> {
    ...
    protected final boolean removeAtMostOneInstance(T instance) {

        Objects.requireNonNull(instance);

        final long index = Array.findAtMostOneIndex(getElementsArray(), instance, 0, IOnlyElementsView.intNumElements(this), (e, i) -> e == i);
    ...
    protected final void removeExactlyOneInstance(T instance) {
