...
abstract class BaseIntLargeSinglyLinkedNodeList<INSTANCE, VALUES extends BaseIntInnerOuterNodeListValues>
    ...
    BaseIntLargeSinglyLinkedNodeList(int initialOuterCapacity, int innerCapacity, ILargeNodeListValuesFactory<int[], IIntInnerOuterNodeListInternal, VALUES> valuesFactory) {
