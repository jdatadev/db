...
abstract class BaseArrayLargeSet<T extends IMutableLargeArrayMarker> extends BaseLongCapacityExponentArrayHashed<T> {

    BaseArrayLargeSet(AllocationType allocationType, int initialOuterCapacityExponent, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor,
    ...
    BaseArrayLargeSet(AllocationType allocationType, BaseLongCapacityExponentArrayHashed<T> toCopy, Function<T, T> copyHashed) {
