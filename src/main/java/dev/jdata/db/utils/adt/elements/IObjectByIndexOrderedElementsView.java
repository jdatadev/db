...
public interface IObjectByIndexOrderedElementsView<T>
    ...
    default boolean containsInstance(T instance) {
        ...
        return ByIndex.containsInstance(this, getNumElements(), instance, IObjectByIndexView::get, IndexOutOfBoundsException::new);
    }

    @Override
    default boolean containsInstance(T instance, long startIndex, long numElements) {

        return ByIndex.containsInstance(this, getNumElements(), instance, startIndex, numElements, IObjectByIndexView::get, IndexOutOfBoundsException::new);
    }

    @Override
    default boolean closureOrConstantContains(Predicate<T> predicate) {

        return ByIndex.contains(this, getNumElements(), predicate, IObjectByIndexView::get, (e, p) -> p.test(e), IndexOutOfBoundsException::new);
    }

    @Override
    default <P> boolean contains(P parameter, IObjectElementPredicate<T, P> predicate) {

        return ByIndex.contains(this, getNumElements(), parameter, IObjectByIndexView::get, predicate, IndexOutOfBoundsException::new);
    }

    @Override
    default <P> boolean contains(long startIndex, long numElements, P parameter, BiPredicate<T, P> predicate) {

        return ByIndex.contains(this, getNumElements(), startIndex, numElements, parameter, IObjectByIndexView::get, predicate, IndexOutOfBoundsException::new);
    }

    @Override
    default long closureOrConstantFindAtMostOneIndex(Predicate<T> predicate) {

        return ByIndex.findAtMostOneIndex(this, getNumElements(), predicate, IObjectByIndexView::get, (e, p) -> p.test(e), IndexOutOfBoundsException::new);
    }

    @Override
    default <P> long findAtMostOneIndex(P parameter, BiPredicate<T, P> predicate) {

        return ByIndex.findAtMostOneIndex(this, getNumElements(), parameter, IObjectByIndexView::get, predicate, IndexOutOfBoundsException::new);
    }

    @Override
    default long closureOrConstantFindAtMostOneIndexInRange(long startIndex, long numElements, Predicate<T> predicate) {

        return ByIndex.findAtMostOneIndex(this, getNumElements(), startIndex, numElements, predicate, IObjectByIndexView::get, predicate != null ? (e, p) -> p.test(e) : null,
    ...
    default <P> long findAtMostOneIndexInRange(long startIndex, long numElements, P parameter, BiPredicate<T, P> predicate) {
        ...
        return ByIndex.findAtMostOneIndex(this, getNumElements(), startIndex, numElements, parameter, IObjectByIndexView::get, predicate, IndexOutOfBoundsException::new);
    }
    ...
    default boolean equalsOrdered(IObjectOrderedElementsView<T> other) {
        ...
        if (thisNumElements != other.getNumElements()) {
            ...
            if (other instanceof IObjectByIndexOrderedElementsView) {
                ...
                equals = equals(0L, otherByIndexOrderedElementsView, 0L, thisNumElements);
            }
            else {
    ...
    @Override
    default <P> void toString(StringBuilder sb, P parameter, ElementsToStringAdder<T, P> elementsToStringAdder) {
