...
abstract class BaseIntegerBucketMap<
    ...
    BaseIntegerBucketMap(MAP toCopy, BiConsumer<KEYS, KEYS> copyHashedContent, Function<VALUES, VALUES> copyValues) {
        super(toCopy, copyHashedContent);

        final BaseIntegerBucketMap<?, ?, ?, ?, ?> other = toCopy;
    ...
    BaseIntegerBucketMap(int initialCapacityExponent, float loadFactor, int bucketsInnerCapacityExponent, IntFunction<KEYS> createHashed, Consumer<KEYS> clearHashed,
    ...
    BaseIntegerBucketMap(int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, int bucketsInnerCapacityExponent, IntFunction<KEYS> createHashed,
