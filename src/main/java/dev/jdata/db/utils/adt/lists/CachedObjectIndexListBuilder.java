...
final class CachedObjectIndexListBuilder<T>
        ...
        extends ObjectIndexListBuilder<T, ICachedIndexList<T>, IHeapIndexList<T>, MutableObjectIndexList<T>, ICachedIndexListBuilder<T>> implements ICachedIndexListBuilder<T> {
