...
abstract class BaseLongLargeSinglyLinkedNodeList<INSTANCE, VALUES extends BaseLongInnerOuterNodeListValues>

        extends BaseLargeSinglyLinkedNodeList<INSTANCE, long[], ILongInnerOuterNodeListInternal, VALUES>
        implements ILongInnerOuterNodeListInternal {

    BaseLongLargeSinglyLinkedNodeList(int initialOuterCapacity, int innerCapacity, ILargeNodeListValuesFactory<long[], ILongInnerOuterNodeListInternal, VALUES> valuesFactory) {
