...
abstract class BaseMutableObjectLargeSinglyLinkedMultiHeadNodeList<INSTANCE, T, VALUES extends BaseObjectInnerOuterNodeValues<T>>
    ...
    BaseMutableObjectLargeSinglyLinkedMultiHeadNodeList(int initialOuterCapacity, int innerCapacity,
