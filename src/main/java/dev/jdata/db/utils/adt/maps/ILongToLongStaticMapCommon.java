...
interface ILongToLongStaticMapCommon extends IBaseLongToLongMapCommon<ILongToLongStaticMapCommon>, ILongToLongStaticMapGetters, IToLongMapGetters<ILongToLongStaticMapCommon> {

    @Override
    default <P1, P2> boolean equals(P1 thisParameter, ILongToLongStaticMapCommon other, P2 otherParameter, ILongValueMapEqualityTester< P1, P2> equalityTester) {
    ...
    default <P1, P2> boolean equalsParameters(LongValueMapScratchEqualsParameter<ILongToLongStaticMapCommon, P1, P2> scratchEqualsParameter) {
