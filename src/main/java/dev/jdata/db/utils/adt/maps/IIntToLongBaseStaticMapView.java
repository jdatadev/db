...
public interface IIntToLongBaseStaticMapView extends IIntToLongMapView, IIntToLongBaseStaticMapGetters, IToLongEqualsGetters<IIntToLongBaseStaticMapView> {

    @Override
    default <P1, P2, E extends Exception> boolean equalsParameters(LongValueMapScratchEqualsParameter<IIntToLongBaseStaticMapView, P1, P2, E> scratchEqualsParameter) throws E {
