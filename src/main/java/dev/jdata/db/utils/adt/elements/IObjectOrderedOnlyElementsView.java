...
public interface IObjectOrderedOnlyElementsView<T> extends IObjectOrderedElementsView<T>, IObjectIterableOnlyElementsView<T> {
    ...
    default <B extends IObjectOrderedOnlyElementsBuilder<R, V, ?>, V extends IObjectOrderedOnlyElementsView<R>, R> V mapOrEmptyInt(IntFunction<B> createBuilder,
    ...
    @Deprecated // necessary?
    default <B extends IObjectOrderedOnlyElementsBuilder<R, V, ?>, V extends IObjectOrderedOnlyElementsView<R>, R> V mapOrNull(IntFunction<B> createBuilder,
            Function<T, R> mapper) {
