...
abstract class BaseIntToObjectMaxDistanceNonBucketMap<V> extends BaseIntToObjectNonBucketMap<V> implements IIntToObjectDynamicMapCommon<V> {
    ...
    BaseIntToObjectMaxDistanceNonBucketMap(int initialCapacityExponent, IntFunction<V[]> createValuesArray) {
    ...
    BaseIntToObjectMaxDistanceNonBucketMap(int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, IntFunction<V[]> createValuesArray) {
    ...
    BaseIntToObjectMaxDistanceNonBucketMap(BaseIntToObjectMaxDistanceNonBucketMap<V> toCopy) {
        super(toCopy);
