...
abstract class BaseObjectToObjectNonContainsKeyNonBucketMap<K, V> extends BaseObjectToObjectNonBucketMap<K, V> implements IObjectToObjectBaseStaticMapCommon<K, V> {
    ...
    BaseObjectToObjectNonContainsKeyNonBucketMap(int initialCapacityExponent, IntFunction<K[]> createKeysArray, IntFunction<V[]> createValuesArray) {
    ...
    BaseObjectToObjectNonContainsKeyNonBucketMap(int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, IntFunction<K[]> createKeysArray,
    ...
    BaseObjectToObjectNonContainsKeyNonBucketMap(BaseObjectToObjectNonContainsKeyNonBucketMap<K, V> toCopy, BiConsumer<V[], V[]> copyValuesContent) {
        super(toCopy);
