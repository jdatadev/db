...
abstract class BaseLongLargeSinglyLinkedMultiHeadNodeList<INSTANCE, VALUES extends BaseLongInnerOuterNodeListValues>

        extends BaseLongLargeSinglyLinkedNodeList<INSTANCE, VALUES>
        implements IBaseMutableLongSinglyLinkedMultiHeadNodeList<INSTANCE> {

    BaseLongLargeSinglyLinkedMultiHeadNodeList(AllocationType allocationType, int initialOuterCapacity, int innerCapacity,
