...
interface IIntToLongMapGetters extends IKeyValueMapGettersHelper<IIntAnyOrderAddable, ILongAnyOrderAddable> {
    ...
    default <P, E extends Exception> void forEachKeyAndValue(P parameter, IIntToLongForEachMapKeyAndValue<P, E> forEach) throws E {
