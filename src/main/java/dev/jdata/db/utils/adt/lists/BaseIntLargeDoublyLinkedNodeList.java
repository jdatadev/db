...
abstract class BaseIntLargeDoublyLinkedNodeList<

                INSTANCE,
                VALUES extends BaseIntInnerOuterNodeListValues>

        extends BaseLargeDoublyLinkedNodeList<INSTANCE, int[], IIntInnerOuterNodeListInternal, VALUES>
        implements IIntNodeListCommon, IIntInnerOuterNodeListInternal {

    BaseIntLargeDoublyLinkedNodeList(int initialOuterCapacity, int innerCapacity, ILargeNodeListValuesFactory<int[], IIntInnerOuterNodeListInternal, VALUES> valuesFactory) {
    ...
    final int removeHeadNodeAndReturnValue(INSTANCE instance, long headNode, long tailNode, ILongNodeSetter<INSTANCE> headNodeSetter, ILongNodeSetter<INSTANCE> tailNodeSetter) {
    ...
    final int removeTailNodeAndReturnValue(INSTANCE instance,  long tailNode, ILongNodeSetter<INSTANCE> headNodeSetter, ILongNodeSetter<INSTANCE> tailNodeSetter) {
