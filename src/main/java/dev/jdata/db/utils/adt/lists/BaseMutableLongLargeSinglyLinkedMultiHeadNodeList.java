...
abstract class BaseMutableLongLargeSinglyLinkedMultiHeadNodeList<INSTANCE, VALUES extends BaseLongInnerOuterNodeListValues>

        extends BaseLongLargeSinglyLinkedMultiHeadNodeList<INSTANCE, VALUES>
        implements IMutableLongLargeSinglyLinkedMultiHeadNodeList<INSTANCE> {

    BaseMutableLongLargeSinglyLinkedMultiHeadNodeList(AllocationType allocationType, int initialOuterCapacity, int innerCapacity,
