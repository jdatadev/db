...
public final class LargeIntMultiHeadSinglyLinkedList<T> extends BaseLargeIntSinglyLinkedList<T> {
    ...
    public boolean removeNodeByValue(T instance, int value, long headNode, long tailNode, LongNodeSetter<T> headNodeSetter, LongNodeSetter<T> tailNodeSetter) {
