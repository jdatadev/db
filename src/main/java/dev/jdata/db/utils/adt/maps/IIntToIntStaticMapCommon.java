...
interface IIntToIntStaticMapCommon extends IBaseIntToIntMapCommon<IIntToIntStaticMapCommon>, IIntToIntStaticMapGetters {

    @Override
    default <P1, P2> boolean equals(P1 thisParameter, IIntToIntStaticMapCommon other, P2 otherParameter, IIntValueMapEqualityTester<P1, P2> equalityTester) {
    ...
    default <P1, P2> boolean equalsParameters(IntValueMapScratchEqualsParameter<IIntToIntStaticMapCommon, P1, P2> scratchEqualsParameter) {
