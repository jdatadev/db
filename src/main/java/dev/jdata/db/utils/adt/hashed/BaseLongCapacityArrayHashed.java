...
abstract class BaseLongCapacityArrayHashed<T extends IMutableLargeArrayMarker> extends BaseLongCapacityHashed<T> {
    ...
    protected static <T> IMutableLongLargeSinglyLinkedMultiHeadNodeList<T> createLongValueBuckets(int initialOuterCapacityExponent, int innerCapacityExponent) {
        ...
        return IHeapMutableLongLargeSinglyLinkedMultiHeadNodeList.create(initialOuterCapacity, innerCapacity);
    }
}
