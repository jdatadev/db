...
abstract class MutableLongLargeArray extends LimitLargeArray<long[][], long[]> implements IMutableLongLargeArray {
    ...
    public final <P1, P2, R, E extends Exception> R forEachWithResult(R defaultResult, P1 parameter1, P2 parameter2, ILongForEachWithResult<P1, P2, R, E> forEach) throws E {
        ...
        default: {
            ...
            final long remaining = Capacity.getRemainderOfLastInnerArrayWithLimit(getLimit(), innerElementCapacity, getNumOuterUtilizedEntries(), numCompleteOuter - 1);
    ...
    public final boolean contains(long value) {
        ...
        if (!isEmpty()) {
            ...
            if (!found) {
                ...
                final long remainder = getLimit() & getInnerIndexMask();
