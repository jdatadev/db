...
abstract class BaseLongLargeKeyNonBucketMap<VALUES> extends BaseLongKeyLargeMap<VALUES> {

    private static final boolean DEBUG = DebugConstants.DEBUG_BASE_LARGE_LONG_KEY_NON_BUCKET_MAP;

    BaseLongLargeKeyNonBucketMap(int initialOuterCapacity, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor,
            BiIntToObjectFunction<VALUES> createValues) {
        super(initialOuterCapacity, innerCapacityExponent, capacityExponentIncrease, loadFactor, (o, i) -> createHashArray(o, i),
                BaseLongLargeKeyNonBucketMap::clearHashArray, createValues);
    ...
    BaseLongLargeKeyNonBucketMap(BaseLongLargeKeyNonBucketMap<VALUES> toCopy, BiConsumer<VALUES, VALUES> copyValuesContent) {
    ...
    @Override
    protected final <S, D> long keysAndValues(IMutableLongLargeArray keysDst, S src, D dst, LongMapIndexValueSetter<S, D> valueSetter) {
    ...
    final <P1, P2, DELEGATE> boolean equalsIntKeyNonBucketMapWithIndex(P1 parameter1, BaseLongLargeKeyNonBucketMap<VALUES> other, P2 parameter2, DELEGATE delegate,
    ...
    private static IMutableLongLargeArray createHashArray(int outerCapacity, int innerCapacityExponent) {
        ...
        return IMutableLongLargeArray.create(outerCapacity, innerCapacityExponent, NO_KEY);
    }
