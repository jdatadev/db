...
abstract class BaseLargeDoublyLinkedNodeList<
    ...
    @Override
    protected final INodeListView createEmpty(AllocationType allocationType, int initialOuterCapacity, int innerCapacity) {
    ...
    final void reallocateOuter(int newOuterCapacity) {
        ...
        this.previous = Arrays.copyOf(previous, newOuterCapacity);
    }
    ...
    final long getPreviousNode(long node) {
