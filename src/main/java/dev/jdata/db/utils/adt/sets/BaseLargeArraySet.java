...
abstract class BaseLargeArraySet<T extends IMutableLargeArrayMarker> extends BaseLongCapacityExponentArrayHashed<T> {
    ...
    BaseLargeArraySet(AllocationType allocationType, int initialOuterCapacity, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor,
    ...
    BaseLargeArraySet(AllocationType allocationType, BaseLongCapacityExponentArrayHashed<T> toCopy, Function<T, T> copyHashed) {
