...
public interface ILongToIntBaseStaticMapView extends ILongToIntMapView, ILongToIntBaseStaticMapGetters, IToIntEqualsGetters<ILongToIntBaseStaticMapView> {

    @Override
    default <P1, P2, E extends Exception> boolean equalsParameters(IntValueMapScratchEqualsParameter<ILongToIntBaseStaticMapView, P1, P2, E> scratchEqualsParameter) throws E {
