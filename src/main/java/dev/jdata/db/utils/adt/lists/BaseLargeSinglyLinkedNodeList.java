...
abstract class BaseLargeSinglyLinkedNodeList<
        ...
        implements ISinglyLinkedMultiHeadNodeListView {
    ...
    @Override
    final void reallocateOuter(int newOuterCapacity) {
    ...
    final void allocateInner(int outerIndex, int innerArrayCapacity) {
        ...
        Checks.isInnerCapacityAboveZero(innerArrayCapacity);
    }
    ...
    final long removeNodeByFindingPreviousNode(INSTANCE instance, long toRemove, long headNode, long tailNode, ILongNodeSetter<INSTANCE> headNodeSetter, ILongNodeSetter<INSTANCE> tailNodeSetter) {
