...
abstract class BaseObjectToObjectMaxDistanceNonBucketMap<K, V> extends BaseObjectToObjectNonBucketMap<K, V> implements IObjectToObjectDynamicMapCommon<K, V> {

    private static final boolean DEBUG = DebugConstants.DEBUG_BASE_OBJECT_MAX_DISTANCE_NON_BUCKET_MAP;

    private byte[] maxDistances;

    BaseObjectToObjectMaxDistanceNonBucketMap(int initialCapacityExponent, IntFunction<K[]> createKeysArray, IntFunction<V[]> createValuesArray) {
    ...
    BaseObjectToObjectMaxDistanceNonBucketMap(int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, IntFunction<K[]> createKeysArray,
    ...
    BaseObjectToObjectMaxDistanceNonBucketMap(BaseObjectToObjectMaxDistanceNonBucketMap<K, V> toCopy) {
        super(toCopy);
