...
abstract class BaseMutableIntLargeSinglyLinkedSingleHeadNodeList<VALUES extends BaseIntInnerOuterNodeListValues>
        ...
        implements IBaseMutableIntSinglyLinkedSingleHeadNodeList {
    ...
    public final long removeNodeByFindingPrevious(long toRemove) {
        ...
        final long result = removeNodeByFindingPreviousNode(this, toRemove, getHeadNode(), getTailNode(), BaseIntLargeSinglyLinkedSingleHeadNodeList::setHeadNode,
                BaseIntLargeSinglyLinkedSingleHeadNodeList::setTailNode);
