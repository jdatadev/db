...
abstract class BaseLongKeyLargeMap<VALUES, MAP extends BaseLongKeyLargeMap<VALUES, MAP>>

        extends BaseNonBucketLargeMap<IMutableLongLargeArray, VALUES, MAP>
        implements ILongKeyMap {

    private static final boolean DEBUG = DebugConstants.DEBUG_BASE_LONG_KEY_LARGE_MAP;

    static final long NO_INDEX = HashArray.NO_INDEX;

    static final long NO_KEY = LongNonBucket.NO_ELEMENT;
