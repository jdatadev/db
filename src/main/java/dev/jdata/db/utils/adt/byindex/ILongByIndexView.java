...
public interface ILongByIndexView extends IByIndexView, ILongByIndexGetters {
    ...
    default <P> long[] toArray(int numElements, P parameter, ObjIntFunction<P, long[]> createArray) {

        Checks.isIntNumElements(numElements);
        Objects.requireNonNull(createArray);

        final long[] dstArray = createArray.apply(parameter, numElements);
    ...
    default void toArray(long[] dst, int numElements) {
