...
abstract class BaseDecimal<T extends BaseDecimal<T>> extends BaseNumber<T> implements IDecimalView {
    ...
    BaseDecimal(AllocationType allocationType, int precision, int scale) {
    ...
    BaseDecimal(AllocationType allocationType, BigDecimal value) {
        super(allocationType, value.precision());
    ...
    final void initialize(BigDecimal bigDecimal) {
        ...
        super.initialize(bigDecimal.precision());
    ...
    @Override
    public int compareTo(IDecimalView other) {

        Objects.requireNonNull(other);

        return compareToOther((BaseDecimal<?>)other);
    }
    ...
    private int compareToOther(BaseDecimal<?> other) {
    ...
    private int compareAfterDecimalPoint(BaseDecimal<?> other, int numBitsBeforeDecimalPoint) {
