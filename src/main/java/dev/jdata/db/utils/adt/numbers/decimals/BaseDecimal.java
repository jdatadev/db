...
abstract class BaseDecimal<T extends BaseDecimal<T>> extends BaseNumber<T> implements IDecimalView, Comparable<T> {
    ...
    BaseDecimal(AllocationType allocationType) {
    ...
    private int compareToOther(BaseDecimal<T> other) {
