...
abstract class BaseLongLargeSinglyLinkedSingleHeadNodeList<VALUES extends BaseLongInnerOuterNodeListValues>

        extends BaseLongLargeSinglyLinkedNodeList<BaseLongLargeSinglyLinkedSingleHeadNodeList<VALUES>, VALUES>
        implements ILongSinglyLinkedSingleHeadNodeListCommon {
    ...
    BaseLongLargeSinglyLinkedSingleHeadNodeList(AllocationType allocationType, int initialOuterCapacity, int innerCapacity,
    ...
    public final <P> boolean contains(P parameter, ILongElementPredicate<P> predicate) {
        ...
        return getValues().containsValue(this, getNumOuterAllocatedEntries(), headNode);
    }
