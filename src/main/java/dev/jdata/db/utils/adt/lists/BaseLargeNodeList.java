...
abstract class BaseLargeNodeList<
    ...
    BaseLargeNodeList(int initialOuterCapacity, int innerNodeCapacity, ILargeNodeListValuesFactory<TO_ARRAY, VALUES_LIST, VALUES> valuesFactory) {
    ...
    final <T extends BaseLargeNodeList<?, ?, ?>> T instantiateOuterCapacityInnerCapacity(BiIntToObjectFunction<T> instantiator) {
