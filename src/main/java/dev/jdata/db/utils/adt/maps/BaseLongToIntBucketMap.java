...
abstract class BaseLongToIntBucketMap<MAP extends BaseLongToIntBucketMap<MAP>>
    ...
    static final class LongToIntBucketMapMultiHeadSinglyLinkedList<INSTANCE>
        ...
        protected INodeListView createEmpty(AllocationType allocationType, int initialOuterCapacity, int innerCapacity) {
            ...
            return new LongToIntBucketMapMultiHeadSinglyLinkedList<>(allocationType, initialOuterCapacity, innerCapacity);
        }
    ...
    BaseLongToIntBucketMap(AllocationType allocationType, int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, int bucketsInnerCapacityExponent) {
        super(allocationType, initialCapacityExponent, capacityExponentIncrease, loadFactor, bucketsInnerCapacityExponent,
                (o, i) -> new LongToIntBucketMapMultiHeadSinglyLinkedList<>(AllocationType.HEAP, o, i));
    ...
    @Override
    final void rehashPut(LongToIntBucketMapMultiHeadSinglyLinkedList<MAP> oldBuckets, long oldNode, LongToIntBucketMapMultiHeadSinglyLinkedList<MAP> newBuckets, long newNode) {
