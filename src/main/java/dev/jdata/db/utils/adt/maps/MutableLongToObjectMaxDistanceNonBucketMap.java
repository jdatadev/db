...
abstract class MutableLongToObjectMaxDistanceNonBucketMap<V, M extends MutableLongToObjectMaxDistanceNonBucketMap<V, M>>

        extends BaseLongToObjectMaxDistanceNonBucketMap<V, M>
        implements IMutableLongToObjectDynamicMap<V> {
