...
final class MutableStringsCharLargeArray extends BaseMutableCharLargeArray implements IMutableStringsCharLargeArray {
    ...
    MutableStringsCharLargeArray(int initialOuterCapacity, int innerCapacityExponent) {
        super(initialOuterCapacity, innerCapacityExponent);
    }

    MutableStringsCharLargeArray(int initialOuterCapacity, int innerCapacityExponent, char clearValue) {
    ...
    @Override
    public boolean containsOnlyCharacters(long index, CharPredicate predicate) {
    ...
    @Override
    public boolean equals(long index, IMutableStringsCharLargeArray otherCharArray, long otherIndex) {

        return equals(index, otherCharArray, otherIndex, true);
    }

    @Override
    public boolean equals(long index, IMutableStringsCharLargeArray otherStringsCharLargeArray, long otherIndex, boolean caseSensitive) {
