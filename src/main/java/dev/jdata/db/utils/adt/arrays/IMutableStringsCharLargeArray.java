...
public interface IMutableStringsCharLargeArray extends IMutable, IClearable {
    ...
    public static IMutableStringsCharLargeArray create(int initialOuterCapacity, int innerCapacityExponent) {

        Checks.isInitialOuterCapacity(initialOuterCapacity);
        Checks.isInnerCapacityExponent(innerCapacityExponent);

        return new MutableStringsCharLargeArray(initialOuterCapacity, innerCapacityExponent);
    }
