...
final class MutableObjectLargeArray<T> extends LimitLargeArray<T[][], T[]> implements IMutableObjectLargeArray<T> {

    private static final boolean DEBUG = DebugConstants.DEBUG_MUTABlE_OBJECT_LARGE_ARRAY;

    private static final Class<?> debugClass = MutableObjectLargeArray.class;

    static <T> MutableObjectLargeArray<T> copyOf(MutableObjectLargeArray<T> toCopy) {
        ...
        final MutableObjectLargeArray<T> result = new MutableObjectLargeArray<>(toCopy);
    ...
    MutableObjectLargeArray(int initialOuterCapacity, int innerCapacityExponent, IntFunction<T[][]> createOuterArray, IntFunction<T[]> createInnerArray) {
    ...
    MutableObjectLargeArray(int initialOuterCapacity, int innerCapacityExponent, IntFunction<T[][]> createOuterArray, IntFunction<T[]> createInnerArray, T clearValue) {
    ...
    private MutableObjectLargeArray(int initialOuterCapacity, int innerCapacityExponent, IntFunction<T[][]> createOuterArray, IntFunction<T[]> createInnerArray, T clearValue,
    ...
    private MutableObjectLargeArray(MutableObjectLargeArray<T> toCopy) {
        super(toCopy, (s, d, n) -> {
