...
abstract class MutableObjectLargeArray<T> extends LimitLargeArray<T[][], T[]> implements IMutableObjectLargeArray<T> {
    ...
    static <T> void checkInstantiateParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, int initialOuterCapacity,
            int innerCapacityExponent, IntFunction<T[][]> createOuterArray, IntFunction<T[]> createInnerArray) {
