...
import dev.jdata.db.utils.adt.lists.IHeapMutableIntLargeSinglyLinkedMultiHeadNodeList;
...
abstract class BaseIntBucketSet

        extends BaseBucketSet<int[], IMutableIntLargeSinglyLinkedMultiHeadNodeList<BaseIntBucketSet>, BaseIntBucketSet>
        implements IBaseIntSetCommon, IIntUnorderedAddable {
    ...
    BaseIntBucketSet(AllocationType allocationType, int initialCapacityExponent, int capacityExponentIncrease, float loadFactor, int bucketsInnerCapacityExponent) {
        super(allocationType, initialCapacityExponent, capacityExponentIncrease, loadFactor, bucketsInnerCapacityExponent, int[]::new, BaseIntBucketSet::clearHashArray,
                IHeapMutableIntLargeSinglyLinkedMultiHeadNodeList::create);
    ...
    BaseIntBucketSet(AllocationType allocationType, BaseIntBucketSet toCopy) {
        ...
        toCopy.forEach(this, (e, p) -> p.addValue(e));
    ...
    public final <P, E extends Exception> void forEach(P parameter, IIntForEach<P, E> forEach) throws E {
        ...
        final IMutableIntSinglyLinkedMultiHeadNodeList<BaseIntBucketSet> buckets = getBuckets();
    ...
    @Override
    void rehashBuckets(int[] hashArray, int[] newHashArray, int newKeyMask, IMutableIntLargeSinglyLinkedMultiHeadNodeList<BaseIntBucketSet> buckets,
            IMutableIntLargeSinglyLinkedMultiHeadNodeList<BaseIntBucketSet> newBuckets) {
    ...
    private boolean add(int[] bucketHeadNodesHashArray, int value, int keyMask) {
        ...
        final IMutableIntLargeSinglyLinkedMultiHeadNodeList<BaseIntBucketSet> buckets = getBuckets();
