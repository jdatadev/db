...
abstract class BaseLongNonBucketSet extends BaseIntegerNonBucketSet<long[]> implements ILongSetCommon {
    ...
    BaseLongNonBucketSet(int initialCapacityExponent, float loadFactor) {
        this(initialCapacityExponent, DEFAULT_CAPACITY_EXPONENT_INCREASE, loadFactor);
    }

    BaseLongNonBucketSet(int initialCapacityExponent, int capacityExponentIncrease, float loadFactor) {
        super(initialCapacityExponent, capacityExponentIncrease, loadFactor, long[]::new, BaseLongNonBucketSet::clearHashArray);
    ...
    BaseLongNonBucketSet(BaseLongNonBucketSet toCopy) {
