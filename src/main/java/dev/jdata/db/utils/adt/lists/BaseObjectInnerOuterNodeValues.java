...
abstract class BaseObjectInnerOuterNodeValues<T> extends BaseInnerOuterNodeListValues<T[], IObjectInnerOuterNodeListInternal<T>> {

    private final IntFunction<T[]> createArray;

    private T[][] values;

    protected BaseObjectInnerOuterNodeValues(int initialOuterCapacity, IntFunction<T[][]> createOuterArray, IntFunction<T[]> createArray) {
