...
public abstract class BaseADTElements<T, U, V> extends Allocatable {
    ...
    protected static void checkOfValueParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
    }

    protected static void checkOfInstanceParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, Object instance) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
        Objects.requireNonNull(instance);
    }

    protected static void checkOfValuesParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, Object array, int arrayLength) {

        checkOfArrayParameters(allocationType, expectedAllocationMechanism, array, arrayLength);
    }

    protected static <T> void checkOfInstancesParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, T[] instances) {

        checkOfArrayParameters(allocationType, expectedAllocationMechanism, instances, instances.length);
        Checks.areNonNullElements(instances);
    }

    private static void checkOfArrayParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, Object array, int arrayLength) {
    ...
    @Deprecated // is CopyOf necessary for mutable types instead of copyToMutable?
    protected static void checkCopyOfParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, IView toCopy) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
        Objects.requireNonNull(toCopy);
    }

    protected static void checkCopyToMutableParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, IMutableFrom mutableFrom) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
        Objects.requireNonNull(mutableFrom);
    }

    protected static void checkMutableCreateParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, int initialCapacity) {

        checkMutableCreateParameters(allocationType, expectedAllocationMechanism);
        Checks.isIntInitialCapacityAtOrAboveZero(initialCapacity);
    }

    protected static void checkMutableCreateParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism) {
    ...
    protected static void checkCopyMutableParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, IMutable mutable) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
        Objects.requireNonNull(mutable);
    }

    protected static void checkWithArrayParameters(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, Object valuesArray, int numElements) {
    ...
    protected static void checkWithMakeElementsFrom(AllocationType allocationType, AllocationMechanism expectedAllocationMechanism, Object from) {

        AllocationType.checkIsAllocationMechanism(allocationType, expectedAllocationMechanism);
        Objects.requireNonNull(from);
    }

    protected final <P, R> void checkMakeFromElementsParameters(AllocationType allocationType, P parameter, IMakeFromElementsFunction<T, U, P, R> makeFromElements) {
    ...
    protected static int intLimit(IScatteredElementsView scatteredElementsView) {

        return IScatteredElementsView.intLimit(scatteredElementsView);
    }
