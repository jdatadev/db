...
abstract class IntIndexListAllocator<
        ...
        extends ListAllocator<IMMUTABLE, HEAP_IMMUTABLE, int[], INTERFACE_MUTABLE, CLASS_MUTABLE, BUILDER, IIntIterableElementsView, IntComparator>
    ...
    @Override
    public final IMMUTABLE sortedOf(IIntIterableElementsView elements, IntComparator comparator) {
