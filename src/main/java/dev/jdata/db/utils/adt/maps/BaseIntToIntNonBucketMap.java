...
abstract class BaseIntToIntNonBucketMap extends BaseIntArrayKeysNonBucketMap<int[]> implements IIntToIntMapCommon {
    ...
    BaseIntToIntNonBucketMap(BaseIntToIntNonBucketMap toCopy) {
