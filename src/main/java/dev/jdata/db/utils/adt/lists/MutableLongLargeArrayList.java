...
public final class MutableLongLargeArrayList extends LargeArray<long[][], long[]> implements IMutableLongIndexList {

    private long numElements;

    public MutableLongLargeArrayList(int initialOuterCapacity, int innerCapacityExponent) {
    ...
    @Override
    public boolean containsOnly(int value, ILongContainsOnlyPredicate predicate) {
    ...
    @Override
    public int removeTailAndReturnValue() {
