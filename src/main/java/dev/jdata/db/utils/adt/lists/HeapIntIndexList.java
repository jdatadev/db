...
final class HeapIntIndexList extends IntIndexList implements IHeapIntIndexList {
    ...
    private static HeapIntIndexList of(AllocationType allocationType, int value) {

        checkOfValueParameters(allocationType, AllocationMechanism.HEAP);

        return new HeapIntIndexList(allocationType, value);
    }
    ...
    static HeapIntIndexList withArray(AllocationType allocationType, int[] array, int numElements) {
        ...
        checkWithArrayParameters(allocationType, AllocationMechanism.HEAP, array, numElements);
