...
abstract class BaseLongLargeNonBucketSet extends BaseIntegerLargeNonBucketSet<IMutableLongLargeArray> implements ILongSetCommon {
    ...
    BaseLongLargeNonBucketSet(int initialCapacityExponent, float loadFactor) {
        this(initialCapacityExponent, DEFAULT_CAPACITY_EXPONENT_INCREASE, DEFAULT_INNER_CAPACITY_EXPONENT, loadFactor);
    }

    BaseLongLargeNonBucketSet(int initialCapacityExponent, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor) {
        super(initialCapacityExponent, capacityExponentIncrease, innerCapacityExponent, loadFactor, BaseLongLargeNonBucketSet::createHashArray,
    ...
    BaseLongLargeNonBucketSet(BaseLongLargeNonBucketSet toCopy) {
        super(toCopy, IMutableLongLargeArray::copyOf);
    ...
    protected IMutableLongLargeArray rehash(IMutableLongLargeArray hashArray, long newCapacity, int newCapacityExponent, long newKeyMask) {
        ...
        final IMutableLongLargeArray newHashArray = IMutableLongLargeArray.create(newCapacity);
    ...
    private static IMutableLongLargeArray createHashArray(int initialOuterCapacity, int innerCapacityExponent) {
        ...
        return IMutableLongLargeArray.create(initialOuterCapacity, innerCapacityExponent, NO_ELEMENT);
    }
