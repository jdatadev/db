...
public interface IIntToObjectBaseStaticMapView<V>

        extends IIntToObjectMapView<V>, IIntToObjectBaseStaticMapGetters<V>, IToObjectEqualsGetters<V, IIntToObjectBaseStaticMapView<V>> {

    @Override
    default <P1, P2, E extends Exception> boolean equalsParameters(ObjectValueMapScratchEqualsParameter<V, IIntToObjectBaseStaticMapView<V>, P1, P2, E> scratchEqualsParameter)
            throws E {
