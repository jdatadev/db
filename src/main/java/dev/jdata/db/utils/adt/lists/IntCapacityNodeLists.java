...
public class IntCapacityNodeLists extends BaseNodeLists {

    public static final int NO_INT_NODE = -1;

    private static final long NO_LONG_NODE = LargeNodeLists.NO_LONG_NODE;

    static int checkIntNodeOuterCapacity(int outerCapacity) {

        return checkIntNodeCapacity(outerCapacity);
    }

    static int checkIntNodeInnerCapacity(int innerCapacity) {
