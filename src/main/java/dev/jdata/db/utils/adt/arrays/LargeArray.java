...
abstract class LargeArray<O, I> extends ExponentLargeArray<O, I> {

    private static final boolean DEBUG = DebugConstants.DEBUG_LARGE_ARRAY;

    LargeArray(AllocationType allocationType, int initialOuterCapacity, int innerCapacityExponent, boolean hasClearValue, IntFunction<O> createOuterArray) {
