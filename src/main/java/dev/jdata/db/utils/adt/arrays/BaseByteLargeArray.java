...
public abstract class BaseByteLargeArray extends LargeExponentArray<byte[][], byte[]> {
    ...
    protected BaseByteLargeArray(int innerCapacityExponent, boolean requiresInnerArrayNumElements) {
    ...
    BaseByteLargeArray(int initialOuterCapacity, int innerCapacityExponent, byte clearValue, boolean hasClearValue, boolean requiresInnerArrayNumElements) {
    ...
    BaseByteLargeArray(BaseByteLargeArray toCopy) {
        super(toCopy, (s, d, n) -> {
