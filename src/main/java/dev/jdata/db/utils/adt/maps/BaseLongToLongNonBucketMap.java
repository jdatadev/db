...
abstract class BaseLongToLongNonBucketMap<M extends IBaseLongToLongMapCommon<M>> extends BaseLongArrayKeysNonBucketMap<long[]> implements IBaseLongToLongMapCommon<M> {
    ...
    BaseLongToLongNonBucketMap(BaseLongToLongNonBucketMap<M> toCopy) {
    ...
    @Override
    public <P, DELEGATE, R> R forEachKeyAndValueWithResult(R defaultResult, P parameter, DELEGATE delegate, IForEachKeyAndValueWithResult<P, DELEGATE, R> forEach) {
    ...
    @Override
    public final void keysAndValues(long[] keysDst, long[] valuesDst) {
    ...
    final <P1, P2, DELEGATE> boolean equalsLongToLongNonBucketMap(P1 parameter1, BaseLongToLongNonBucketMap<M> other, P2 parameter2,
