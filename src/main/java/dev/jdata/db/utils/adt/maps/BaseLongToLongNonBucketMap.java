...
abstract class BaseLongToLongNonBucketMap<M extends BaseLongToLongNonBucketMap<M>> extends BaseLongArrayKeysNonBucketMap<long[], M> implements ILongToLongMapCommon {

    private static final boolean DEBUG = DebugConstants.DEBUG_BASE_LONG_TO_LONG_NON_BUCKET_MAP;

    BaseLongToLongNonBucketMap(AllocationType allocationType, int initialCapacityExponent) {
        super(allocationType, initialCapacityExponent, long[]::new);
    ...
    BaseLongToLongNonBucketMap(AllocationType allocationType, int initialCapacityExponent, int capacityExponentIncrease, float loadFactor) {
    ...
    BaseLongToLongNonBucketMap(AllocationType allocationType, BaseLongToLongNonBucketMap<M> toCopy) {
    ...
    @Override
    public final <P, E extends Exception> void forEachKeyAndValue(P parameter, ILongToLongForEachMapKeyAndValue<P, E> forEach) throws E {
    ...
    @Override
    public <P1, P2, R, E extends Exception> R forEachKeyAndValueWithResult(R defaultResult, P1 parameter1, P2 parameter2,
        ...
        if (DEBUG) {
            ...
            enter(b -> b.add("defaultResult", defaultResult).add("parameter", parameter1).add("parameter2", parameter2).add("forEach", forEach));
        }
    ...
    @Override
    public final long keysAndValues(ILongAnyOrderAddable keysDst, ILongAnyOrderAddable valuesDst) {
    ...
    final void clearBaseLongToLongNonBucketMap() {
    ...
    final <P1, P2, DELEGATE, E extends Exception> boolean equalsLongToLongNonBucketMap(P1 parameter1, BaseLongToLongNonBucketMap<?> other, P2 parameter2,
