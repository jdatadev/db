...
abstract class BaseIntToObjectNonContainsKeyNonBucketMap<V, M extends BaseIntToObjectNonContainsKeyNonBucketMap<V, M>>

        extends BaseIntToObjectNonBucketMap<V, M>
    ...
    BaseIntToObjectNonContainsKeyNonBucketMap(AllocationType allocationType, BaseIntToObjectNonContainsKeyNonBucketMap<V, M> toCopy) {
    ...
    protected final <P, R> R makeFromElements(AllocationType allocationType, P parameter, IMakeFromElementsFunction<Void, M, P, R> makeFromElements) {
        ...
        final M mapThis = (M)this;

        return makeFromElements.apply(allocationType, null, mapThis, getMakeFromElementsNumElements(), parameter);
    }
