...
abstract class BaseLongLargeBucketSet extends BaseLargeIntegerBucketSet<IMutableLongLargeArray> implements ILongSetCommon {
    ...
    BaseLongLargeBucketSet(int initialOuterCapacityExponent, int capacityExponentIncrease, int innerCapacityExponent, float loadFactor) {
        super(initialOuterCapacityExponent, capacityExponentIncrease, innerCapacityExponent, loadFactor, BaseLongLargeBucketSet::createHashArray,
    ...
    BaseLongLargeBucketSet(int initialOuterCapacityExponent, int innerCapacityExponent, long[] values) {
    ...
    private BaseLongLargeBucketSet(int initialOuterCapacity, int innerCapacityExponent) {
