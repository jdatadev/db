...
interface ILongToObjectStaticMapCommon<T> extends IBaseLongToObjectMapCommon<T, ILongToObjectStaticMapCommon<T>>, ILongToObjectStaticMapGetters<T> {

    @Override
    default <P1, P2> boolean equals(P1 thisParameter, ILongToObjectStaticMapCommon<T> other, P2 otherParameter, IObjectValueMapEqualityTester<T, P1, P2> equalityTester) {
    ...
    default <P1, P2> boolean equalsParameters(ObjectValueMapScratchEqualsParameter<T, ILongToObjectStaticMapCommon<T>, P1, P2> scratchEqualsParameter) {
