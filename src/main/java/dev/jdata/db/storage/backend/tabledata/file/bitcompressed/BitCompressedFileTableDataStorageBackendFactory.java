...
public final class BitCompressedFileTableDataStorageBackendFactory extends BaseFileTableDataStorageBackendFactory {
    ...
    @Override
    protected TableDataStorageBackend createTableStorageBackend(VersionedDatabaseSchemas versionedDatabaseSchemas,
            TableByIdMap<FileTableStorageFiles> fileTableStorageByTableId) {

        return new BitCompressedFileTableStorageBackend(versionedDatabaseSchemas, fileTableStorageByTableId);
    }
}
