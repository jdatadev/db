...
public final class FileTableStorageFiles extends BaseStorageFiles<RandomFileAccess, FileTableStorageFile> {
    ...
    FileTableStorageFiles(IRelativeFileSystemAccess fileSystemAccess, RelativeDirectoryPath tableDirectoryPath, IIndexList<FileTableStorageFile> files,
            IIndexListAllocator<FileTableStorageFile, ? extends IndexList<FileTableStorageFile>, ? extends IMutableIndexList<FileTableStorageFile>> indexListAllocator) {
    ...
    private static <T> T binarySearch(IObjectIndexListView<T> list, long toFind, RangeGetter<T> rangeGetter) {
    ...
    private static <T> T binarySearch(IObjectIndexListView<T> list, long beginIndex, long numElements, long toFind, RangeGetter<T> rangeGetter) {
