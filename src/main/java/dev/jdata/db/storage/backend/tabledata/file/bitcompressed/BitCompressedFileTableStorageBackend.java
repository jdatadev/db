...
final class BitCompressedFileTableStorageBackend extends BaseFileTableDataStorageBackend {
    ...
    BitCompressedFileTableStorageBackend(VersionedDatabaseSchemas versionedDatabaseSchemas, TableByIdMap<FileTableStorageFiles> fileTableStorageByTableId) {
        super(versionedDatabaseSchemas, fileTableStorageByTableId);
    }
    ...
    protected StorageTableFileSchema adjustStorageTableFileSchema(StorageTableFileSchema currentStorageTableFileSchema, long rowId, long transactionId,
        ...
        final int numInputRowIdBits = BitsUtil.getNumBits(rowId, false);
        final int numInputTransactionIdBits = BitsUtil.getNumBits(transactionId, false);
