...
final class SimpleFileTableDataStorageBackend extends BaseFileTableDataStorageBackend {
    ...
    SimpleFileTableDataStorageBackend(VersionedDatabaseSchemas versionedDatabaseSchemas, TableByIdMap<FileTableStorageFiles> fileTableStorageByTableId) {
    ...
    protected void setDeleteMarker(byte[] outputRowBuffer, long outputRowBufferBitOffset) {
        ...
        BitBufferUtil.setBits(outputRowBuffer, outputRowBufferBitOffset, 8, true);
    }
}
