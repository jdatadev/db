...
import dev.jdata.db.utils.adt.lists.IHeapMutableLongLargeDoublyLinkedSingleHeadNodeList;
import dev.jdata.db.utils.adt.lists.IHeapMutableLongLargeSinglyLinkedSingleHeadNodeList;
import dev.jdata.db.utils.adt.lists.IMutableLongLargeDoublyLinkedSingleHeadNodeList;
import dev.jdata.db.utils.adt.lists.IMutableLongLargeSinglyLinkedSingleHeadNodeList;
...
public final class RowCache extends BaseRows implements DataCache {
    ...
    private final IMutableLongLargeDoublyLinkedSingleHeadNodeList insertionOrderList;
    private final IMutableLongLargeSinglyLinkedSingleHeadNodeList insertionOrderFreeList;
    ...
    public RowCache() {
        ...
        this.insertionOrderList = IHeapMutableLongLargeDoublyLinkedSingleHeadNodeList.create(initialInsertionOrderListOuterCapacity, insertOrderListInnerCapacity);
        this.insertionOrderFreeList = IHeapMutableLongLargeSinglyLinkedSingleHeadNodeList.create(initialInsertionOrderListOuterCapacity, insertOrderListInnerCapacity);
    }
