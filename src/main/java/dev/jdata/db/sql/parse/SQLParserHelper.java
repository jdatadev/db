...
public final class SQLParserHelper<
                ...
                T extends IBaseIndexList<BaseSQLStatement>,
                U extends IIndexListBuilder<BaseSQLStatement, T>,
                V extends IBaseIndexListAllocator<BaseSQLStatement, T, U>> {
    ...
    private static <T> void toIndexList(IAddableList<T> addableList, IObjectOrderedAddable<T> dst) {
        ...
        final int numElements = IElementsView.intNumElements(addableList.getNumElements());
