...
//        throw new UnsupportedOperationException();
    ...
    protected static <E extends Exception, I extends CharInput<E>> SQLColumnNames parseColumnNames(SQLLexer<E, I> lexer, ISQLAllocator allocator, boolean hasParenthesis)
        ...
        final ICachedLongIndexList names = parseNames(lexer, allocator);
    ...
    protected static <E extends Exception, I extends CharInput<E>> ICachedLongIndexList parseNames(SQLLexer<E, I> lexer, ISQLAllocator allocator) throws ParserException, E {

        Objects.requireNonNull(lexer);
        Objects.requireNonNull(allocator);

        final ICachedLongIndexList result;

        final ICachedLongIndexListBuilder namesBuilder = allocator.createLongIndexListBuilder(10);
        ...
        try {
            ...
            result = namesBuilder.buildOrEmpty();
        }
        finally {
