...
//        throw new UnsupportedOperationException();
    ...
    protected static <E extends Exception, I extends CharInput<E>> SQLColumnNames parseColumnNames(SQLLexer<E, I> lexer, ISQLAllocator allocator, boolean hasParenthesis)
        ...
        final IHeapLongIndexList names = parseNames(lexer, allocator);
    ...
    protected static <E extends Exception, I extends CharInput<E>> IHeapLongIndexList parseNames(SQLLexer<E, I> lexer, ISQLAllocator allocator) throws ParserException, E {
        ...
        try {
            ...
            result = namesBuilder.buildHeapAllocatedOrEmpty();
        }
        finally {
