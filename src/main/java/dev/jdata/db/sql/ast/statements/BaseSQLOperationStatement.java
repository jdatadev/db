...
public abstract class BaseSQLOperationStatement extends BaseSQLStatement {

    private final long operationKeyword;
    private final long objectKeyword;
    private final long name;

    protected BaseSQLOperationStatement(Context context, long operationKeyword, long objectKeyword, long name) {
        super(context);
