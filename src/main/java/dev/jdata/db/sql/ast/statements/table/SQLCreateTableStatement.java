...
public final class SQLCreateTableStatement extends SQLTableStatement {
    ...
    public SQLCreateTableStatement(Context context, long operationKeyword, long tableKeyword, long tableName, IIndexListView<SQLTableColumnDefinition> columns) {
    ...
    private SQLCreateTableStatement(Context context, long operationKeyword, long tableKeyword, long tableName, IIndexListView<SQLTableColumnDefinition> columns,
