...
final class SchemaMap<T extends SchemaObject> extends DBNamedObjectMap<T, SchemaMap<T>> implements SchemaMapGetters<T> {

    private final List<T> schemaObjects;

/*
    SchemaMap(int initialCapacity) {
...
*/
    ...
    SchemaMap(List<T> schemaObjects) {
        super(schemaObjects);
