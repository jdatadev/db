...
public final class DatabaseSchemaStorageFactory implements IDatabaseSchemaStorageFactory<IOException> {
    ...
    @Override
    public final IDatabaseSchemaRetrieval<IOException> createSchemaDiffRetrieval(DatabaseSchemaVersion databaseSchemaVersion) throws IOException {
    ...
    @Override
    public final void listVersions(IIntAnyOrderAddable dst) {
