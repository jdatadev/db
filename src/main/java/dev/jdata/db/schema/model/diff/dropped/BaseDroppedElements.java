...
public abstract class BaseDroppedElements<T extends IMutableIntSet> extends ObjectCacheNode implements IDroppedElements {
    ...
    final void add(BaseDroppedElements<T> other, IIntToObjectMapAllocator<T> intToObjectMapAllocator, IMutableIntSetAllocator<T> intSetAllocator) {
    ...
    final void initialize(BaseDroppedElements<T> other, IIntToObjectMapAllocator<T> intToObjectMapAllocator, IMutableIntSetAllocator<T> intSetAllocator) {
    ...
    final void addDroppedSchemaObject(SchemaObject schemaObject, IMutableIntSetAllocator<T> intSetAllocator) {
    ...
    final void addDroppedColumn(int columnsObjectId, int columnId, IMutableIntSetAllocator<T> intSetAllocator) {
    ...
    final void free(IIntToObjectMapAllocator<T> intToObjectMapAllocator, IMutableIntSetAllocator<T> intSetAllocator) {
