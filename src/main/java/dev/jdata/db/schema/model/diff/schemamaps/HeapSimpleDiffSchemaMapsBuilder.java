...
final class HeapSimpleDiffSchemaMapsBuilder<T extends SchemaObject>
    ...
    HeapSimpleDiffSchemaMapsBuilder(AllocationType allocationType) {
    ...
    protected IHeapDiffSchemaMaps build(AllocationType allocationType, IHeapSchemaMap<T>[] mutable) {
        ...
        checkSchemaMapsBuildParameters(allocationType, AllocationMechanism.HEAP, mutable);
