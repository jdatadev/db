...
public interface ISchemaObjects {
    ...
    <T extends SchemaObject> IBaseIndexList<T> getSchemaObjects(DDLObjectType ddlObjectType);
    ...
    default IBaseIndexList<Table> getTables() {

        return getSchemaObjects(DDLObjectType.TABLE);
    }

    default IBaseIndexList<View> getViews() {
