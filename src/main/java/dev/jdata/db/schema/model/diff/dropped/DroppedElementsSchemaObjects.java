...
import dev.jdata.db.utils.adt.sets.IBaseMutableIntSet;
...
public final class DroppedElementsSchemaObjects extends ObjectCacheNode implements IDroppedElementsSchemaObjects {

    private final DroppedElements[] droppedElementsArray;

    public DroppedElementsSchemaObjects() {
        this(DroppedElements[]::new);
    }

    private DroppedElementsSchemaObjects(IntFunction<DroppedElements[]> createDroppedElementsArray) {

        Objects.requireNonNull(createDroppedElementsArray);

        this.droppedElementsArray = createDroppedElementsArray.apply(DDLObjectType.getNumObjectTypes());
    }

    public final void initialize(DroppedElementsSchemaObjects other, DroppedSchemaObjectsAllocator droppedSchemaObjectsAllocator) {
        ...
        final IIntToObjectMapAllocator<IBaseMutableIntSet> intToObjectMapAllocator = droppedSchemaObjectsAllocator.getIntToObjectMapAllocator();
        final IBaseMutableIntSetAllocator intSetAllocator = droppedSchemaObjectsAllocator.getMutableIntSetAllocator();
    ...
    public final void add(IDroppedElementsSchemaObjects other, DroppedSchemaObjectsAllocator droppedSchemaObjectsAllocator) {
        ...
        final DroppedElementsSchemaObjects otherDroppedSchemaObjects = (DroppedElementsSchemaObjects)other;
    ...
    public final void addDroppedSchemaObject(DDLObjectType ddlObjectType, SchemaObject schemaObject, DroppedSchemaObjectsAllocator droppedSchemaObjectsAllocator) {
    ...
    private void addDroppedSchemaObject(DDLObjectType ddlObjectType, SchemaObject schemaObject, IDroppedElementsAllocator droppedElementsAllocator,
            IBaseMutableIntSetAllocator intSetAllocator) {
    ...
    public final void addDroppedColumn(DDLObjectType ddlObjectType, ColumnsObject columnsObject, Column column, IDroppedElementsAllocator droppedElementsAllocator,
            IBaseMutableIntSetAllocator intSetAllocator) {
