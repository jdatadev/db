...
public abstract class BaseSimpleSchemaMapsBuilder<
    ...
    @Override
    public final SCHEMA_MAPS_BUILDER addSchemaObject(SCHEMA_OBJECT schemaObject) {
    ...
    @Override
    public final SCHEMA_MAPS_BUILDER addSchemaObjects(ISchemaObjects schemaObjects) {
