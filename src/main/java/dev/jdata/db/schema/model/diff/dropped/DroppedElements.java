...
final class DroppedElements<T extends IMutableIntSet, U extends IMutableIntToObjectWithRemoveStaticMap<T>> extends ObjectCacheNode implements IDroppedElements {
    ...
    final void free(IMutableIntToObjectWithRemoveStaticMapAllocator<T, U> mutableIntToObjectMapAllocator, IMutableIntSetAllocator<T> mutableIntSetAllocator) {
        ...
        if (droppedColumnsByColumnObjectId != null) {
            ...
            mutableIntToObjectMapAllocator.freeMutable(droppedColumnsByColumnObjectId);
        }
    }
}
