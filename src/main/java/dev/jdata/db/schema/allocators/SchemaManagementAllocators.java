 ...
 */
public final class SchemaManagementAllocators<T extends IMutableIntSet, U extends IMutableIntToObjectWithRemoveStaticMap<T>> implements IAllocators {
    ...
    private final SchemaDroppedElementsAllocators<T, U> schemaDroppedElementsAllocators;
    ...
    public SchemaManagementAllocators(IMutableIntSetAllocator<?> intSetAllocator) {
        ...
        this.schemaDroppedElementsAllocators = null; // new HeapDroppedSchemaObjectsAllocator(intSetAllocator, mutableIntToObjectMapAllocator);
        this.databaseSchemasAllocator = new HeapDatabaseSchemasAllocator(schemaDroppedElementsAllocators);
        this.schemaManagerAllocator = new HeapDatabasesSchemaManagerAllocator(schemaDroppedElementsAllocators, databaseSchemasAllocator);
    }
    ...
    public void gatherStatistics(IAllocatorsStatisticsGatherer statisticsGatherer) {
        ...
        statisticsGatherer.addAllocators("droppedSchemaObjectsAllocator", RefType.INSTANTIATED, schemaDroppedElementsAllocators);
