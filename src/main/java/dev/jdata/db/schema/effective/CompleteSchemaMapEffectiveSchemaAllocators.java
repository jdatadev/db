...
abstract class CompleteSchemaMapEffectiveSchemaAllocators<
        ...
        extends SchemaMapEffectiveSchemaAllocators<
                        ...
                        ICompleteSchemaMapBuilderAllocator<COMPLETE_SCHEMA_MAP, HEAP_COMPLETE_SCHEMA_MAP, COMPLETE_SCHEMA_MAP_BUILDER>> {

    CompleteSchemaMapEffectiveSchemaAllocators(IIndexListAllocator<Column, ?, ?, COLUMN_INDEX_LIST_BUILDER> columnIndexListAllocator,
