...
public abstract class SchemaMapEffectiveSchemaAllocators<
    ...
    SchemaMapEffectiveSchemaAllocators(IIndexListAllocator<Column, ?, ?, COLUMN_INDEX_LIST_BUILDER> columnIndexListAllocator,
        ...
        this.schemaObjectIndexListAllocators = Objects.requireNonNull(indexListAllocators);
    }

    public final SchemaObjectIndexListAllocators<SCHEMA_OBJECT_INDEX_LIST_ALLOCATOR> getSchemaObjectIndexListAllocators() {
