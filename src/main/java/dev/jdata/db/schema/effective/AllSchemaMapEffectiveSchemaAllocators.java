...
public abstract class AllSchemaMapEffectiveSchemaAllocators<
        ...
        extends SchemaMapEffectiveSchemaAllocators<
                        ...
                        IAllCompleteSchemaMapsBuilderAllocator<COMPLETE_SCHEMA_MAPS, HEAP_COMPLETE_SCHEMA_MAPS, COMPLETE_SCHEMA_MAPS_BUILDER>> {

    AllSchemaMapEffectiveSchemaAllocators(IIndexListAllocator<Column, ?, ?, ?> columnIndexListAllocator, IMutableIntSetAllocator<MUTABLE_INT_SET> intSetAllocator,
