...
public abstract class AllSchemaMapEffectiveSchemaAllocators<
        ...
        extends SchemaMapEffectiveSchemaAllocators<
                        ...
                        SCHEMA_MAP,
                        SCHEMA_MAP_BUILDER,
                        ALL_COMPLETE_SCHEMA_MAPS,
                        HEAP_ALL_COMPLETE_SCHEMA_MAPS,
                        ALL_COMPLETE_SCHEMA_MAPS_BUILDER,
                        IAllCompleteSchemaMapsBuilderAllocator<ALL_COMPLETE_SCHEMA_MAPS, HEAP_ALL_COMPLETE_SCHEMA_MAPS, ALL_COMPLETE_SCHEMA_MAPS_BUILDER>> {

    AllSchemaMapEffectiveSchemaAllocators(IIndexListAllocator<Column, ?, ?, COLUMN_INDEX_LIST_BUILDER> columnIndexListAllocator,
